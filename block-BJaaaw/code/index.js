...
let num_month = Number(prompt("Enter the number of a montth"));
switch(num_month) {
  case 1: 
    alert("31 days");
    break;
...
switch(true) {
  case salary <= 20000 :
      in_hand_amt = salary - ((salary * 10) / 100);
      alert(in_hand_amt);
      break;
  case salary <= 40000: 
        in_hand_amt = salary - ((salary * 20) / 100);
        alert(in_hand_amt);
        break;
  case salary > 50000:
        in_hand_amt = salary - ((salary * 30) / 100);
        alert(in_hand_amt);
        break;
  default:  
      alert("Enter the correct salary");
  }
