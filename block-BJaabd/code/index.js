...
let n = Number(prompt("Enter the value for n"));
let word = "";
for(let i = 0; i < n; i++) {
  word += "e";
}
...
// [Your code goes here]
 ...
 n = Number(prompt("Enter the input"));
let sum = 0;
for(let i = 1; i <= n; i++) {
  sum += i;
}
...
*/
// [Your code goes here]
  let number = Number(prompt("Enter the value of number"));
  switch (number) {
    case 1: 
        alert("ONE");
        break;
...
// [Your code goes here]
  ...
  let numC = Number(prompt("Enter numC"));
  let product = numA * numB * numC;
  if(product >= 0) {
    alert("Product numA, numB and numC is positive")
  } else {
    alert("Product of numA, numB and numC is negative");
  }
/* Calculator
